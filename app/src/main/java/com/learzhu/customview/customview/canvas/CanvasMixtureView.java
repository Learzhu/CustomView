 ...
 * @author Learzhu
 * @version $Rev$
 * @time 2016/9/11 14:25
 * @des ${TODO}
 * @updateAuthor $Author$
 * @updateDate $Date$  14:25
 * @updateDes ${TODO}
 */
public class CanvasMixtureView extends View {
    private Context mContext;
    //定义一个paint
    private Paint mPaint;

    public CanvasMixtureView(Context context) {
        this(context, null);
    }

    public CanvasMixtureView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CanvasMixtureView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.mContext = context;
    }

    public CanvasMixtureView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
